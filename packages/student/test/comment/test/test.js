...
onShareAppMessage: function () {
  ...
  return app.shareTool.getShareReturnInfo('0,1', 'test', paramStr, this.shareImagePath ? this.shareImagePath : '', wx.getStorageSync('shareHead').final + that.data.ques_info.title)
},
// // 处理图片
